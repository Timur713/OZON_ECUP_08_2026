...
run excap_c1_dens  --anchor-start 186 --anchor-stride 4  --width 96  --epochs 2
run excap_c2_wide  --anchor-start 186 --anchor-stride 12 --width 192 --epochs 2
echo "FACTORIAL_CORE_DONE $(date --iso-8601=seconds)"
