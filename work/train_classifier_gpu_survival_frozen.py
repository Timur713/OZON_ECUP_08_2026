...
class Network(nn.Module):
    def __init__(
        ...
        static_features=0, survival_head=False,
    ):
        super().__init__()
        ...
        summary_width = summary_channels * len(self.summary_windows) * 2
        self.trunk = nn.Sequential(
            nn.Linear(width * 3 + summary_width + static_features, 512),
...
def main():
    ...
    network = Network(
        ...
        args.blocks,
        args.window,
        summary_channels=nchannels if args.summary else 0,
        static_features=(
