#!/usr/bin/env python
"""Apply fold-342 matched-control choices once to untouched fold 378."""
...
SELECT_TAG = os.environ.get("ECUP_SELECT_TAG", "control409_select342")
HOLDOUT_TAG = os.environ.get("ECUP_HOLDOUT_TAG", "control409_holdout378")
OUTPUT_TAG = os.environ.get("ECUP_TAG", "control409_growth")
...
def main():
    ...
    report = {
        ...
        "role": "matched control for event409_growth",
        "selection_fold": 342,
    ...
    for comparison_tag in ("w409c", "event409_growth"):
